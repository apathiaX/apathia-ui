(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@apathia/apathia.button"), require("@apathia/apathia.twind"), require("@apathia/apathia.form"), require("@apathia/apathia.icon"), require("@apathia/apathia.input"), require("@apathia/apathia.custom-render"), require("@apathia/apathia.alert"), require("@apathia/apathia.modal"), require("@apathia/apathia.confirm"), require("@apathia/apathia.upload"), require("@apathia/apathia.select"), require("@apathia/apathia.radio"), require("@apathia/apathia.checkbox"), require("@apathia/apathia.loading"), require("@apathia/apathia.hooks"), require("@apathia/apathia.collapse"), require("@apathia/apathia.table"), require("@apathia/apathia.pagination")) : typeof define === "function" && define.amd ? define(["exports", "@apathia/apathia.button", "@apathia/apathia.twind", "@apathia/apathia.form", "@apathia/apathia.icon", "@apathia/apathia.input", "@apathia/apathia.custom-render", "@apathia/apathia.alert", "@apathia/apathia.modal", "@apathia/apathia.confirm", "@apathia/apathia.upload", "@apathia/apathia.select", "@apathia/apathia.radio", "@apathia/apathia.checkbox", "@apathia/apathia.loading", "@apathia/apathia.hooks", "@apathia/apathia.collapse", "@apathia/apathia.table", "@apathia/apathia.pagination"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apathia = {}, global.button, global.twind, global.form, global.icon, global.input, global["custom-render"], global.alert, global.modal, global.confirm, global.upload, global.select, global.radio, global.checkbox, global.loading, global.hooks, global.collapse, global.table, global.pagination));
})(this, function(exports2, apathia_button, apathia_twind, apathia_form, apathia_icon, apathia_input, apathia_customRender, apathia_alert, apathia_modal, apathia_confirm, apathia_upload, apathia_select, apathia_radio, apathia_checkbox, apathia_loading, apathia_hooks, apathia_collapse, apathia_table, apathia_pagination) {
  "use strict";
