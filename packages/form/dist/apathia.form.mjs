...
const _sfc_main$1 = defineComponent({
  ...
  setup(props) {
    provide(FORM_ITEM_INLINE_KEY, computed(() => props.inline));
    provide(FORM_DISABLE_KEY, computed(() => !!props.disabled));
    provide(FORM_LABEL_WIDTH_KEY, computed(() => props.labelWidth));
    provide(FORM_LABEL_POSITION_KEY, computed(() => props.labelPosition));
    provide(FORM_LABEL_ALIGN_KEY, computed(() => props.labelAlign));
...
const _sfc_main = defineComponent({
  ...
  setup(props) {
    ...
    const realLabelPosition = useInjectProp(FORM_LABEL_POSITION_KEY, "left", toRef(props, "labelPosition"));
    const realLabelAlign = useInjectProp(FORM_LABEL_ALIGN_KEY, "top", toRef(props, "labelAlign"));
    const realLabelWidth = useInjectProp(FORM_LABEL_WIDTH_KEY, 80, toRef(props, "labelWidth"));
    const realFormItemInline = useInjectProp(FORM_ITEM_INLINE_KEY, false, toRef(props, "inline"));
