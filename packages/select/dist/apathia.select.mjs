...
const _sfc_main$1 = defineComponent({
  ...
  setup(props, ctx) {
    const { disabled, modelValue, valueKey, filterable, emptyText, maxHeight, placeholder } = toRefs(props);
    ...
    const styles = {
      ...
      disabled: style("cursor-not-allowed pointer-events-none bg-gray-100 border-gray-100 placeholder-gray-300"),
      active: style(""),
      ...
      arrow: style("ml-3 absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none h-9 w-7 text-brand-700"),
      clearableIcon: style("hidden absolute w-4 h-4 rounded-full top-2.5 right-8 items-center bg-brand-300 text-white cursor-pointer hover:bg-brand-500"),
